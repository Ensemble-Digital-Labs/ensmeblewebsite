...
/**
 * Soft radial spotlight that follows the pointer inside its parent (parent gets `relative` + `overflow-hidden`).
 */
export function Spotlight({
  ...
  const gradientFill =
    typeof fill === 'string' && fillPresets[fill] ? fillPresets[fill] : fillPresets.white
