...
import { isMarketingDocAtmosphereRoute } from '../../lib/atmosphericRoutes'
 ...
 * `/services/*` and `/ai/*` routes use the shared home atmosphere shell.
      ...
      <div className="max-w-3xl space-y-8 pt-10">
        {doc.sections.map((section, i) => (
          <div key={i}>
            ...
            <p className="text-base leading-relaxed text-white/70 sm:text-lg sm:leading-relaxed">{section.body}</p>
          </div>
        ))}
      </div>
