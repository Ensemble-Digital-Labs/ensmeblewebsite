...
function Page2() {
  return (
    ...
    >
      ...
      <div className="text-content relative z-10 w-full max-w-[90%] md:absolute md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 flex flex-col gap-6 md:flex-row md:gap-[10vw] md:w-[60%] md:max-w-none items-start">
