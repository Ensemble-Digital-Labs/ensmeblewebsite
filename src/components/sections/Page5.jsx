    ...
    >
      <div className="main-text2 absolute top-[40%] left-[55%] transform -translate-x-1/2 -translate-y-1/2 font-antique text-[4vw] w-[60vw] flex flex-col leading-[8vw] text-text-primary">
        ...
        <span id="m-txt" className="flex items-center justify-between relative left-[-8vw]">
          <h1 className="tracking-[-0.5vw]">future together</h1>
          <Link to="/contact" className="menu nav-cta responsive-btn mt2-btn bg-[#FFD074] border-none rounded-[5vw] px-[2vw] py-[1vw] font-bold relative overflow-hidden no-underline text-inherit">
